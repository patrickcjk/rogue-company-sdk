...
public:
	...
	class UWheeledVehicleMovementComponent*            _WheeledVehicleMovementComponent;                         // 0x0920(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	class UTireType*                                   _TireType;                                                // 0x0058(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTireConfig*                                 _TireConfig;                                              // 0x0060(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<EWheelSweepType>                       _SweepType;                                               // 0x0088(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class USkeletalMeshComponent*                      _Mesh;                                                    // 0x0390(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UWheeledVehicleMovementComponent*            _VehicleMovement;                                         // 0x0398(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
