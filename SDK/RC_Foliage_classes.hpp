...
{
public:
	struct FScriptMulticastDelegate                    OnInstanceTakePointDamage;                                // 0x07D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x07E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	EFoliageScaling                                    _Scaling;                                                 // 0x0044(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<EFoliageVertexColorMask>               _VertexColorMask;                                         // 0x0090(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	TEnumAsByte<EComponentMobility>                    _Mobility;                                                // 0x011C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	ELightmapType                                      _LightmapType;                                            // 0x0130(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	struct FBodyInstance                               _BodyInstance;                                            // 0x0138(0x0148) (Edit)
	TEnumAsByte<EHasCustomNavigableGeometry>           _CustomNavigableGeometry;                                 // 0x0280(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLightingChannels                           _LightingChannels;                                        // 0x0281(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
...
{
public:
	class UStaticMesh*                                 _Mesh;                                                    // 0x0358(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           _CapsuleComponent;                                        // 0x0340(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	class AProceduralFoliageVolume*                    _ProceduralFoliageVolume;                                 // 0x0368(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UProceduralFoliageSpawner*                   _FoliageSpawner;                                          // 0x00F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UProceduralFoliageSpawner*                   _FoliageSpawner;                                          // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
