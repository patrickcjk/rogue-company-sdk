...
public:
	...
	class UPathFollowingComponent*                     _PathFollowingComponent;                                  // 0x03E8(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             _BrainComponent;                                          // 0x03F0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      _PerceptionComponent;                                     // 0x03F8(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       _ActionsComp;                                             // 0x0400(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        _Blackboard;                                              // 0x0408(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	EAISenseNotifyType                                 _NotifyType;                                              // 0x002C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EBTFlowAbortMode>                      _FlowAbortMode;                                           // 0x0064(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FBlackboardKeySelector                      _BlackboardKey;                                           // 0x0068(0x0028) (Edit)
...
{
public:
	class UPawnAction*                                 _Action;                                                  // 0x0070(0x0008) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EEnvTestPurpose>                       _TestPurpose;                                             // 0x0034(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TEnumAsByte<EEnvTestFilterType>                    _FilterType;                                              // 0x004A(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x004B(0x0005) MISSED OFFSET
	struct FAIDataProviderBoolValue                    _BoolValue;                                               // 0x0050(0x0030) (Edit, DisableEditOnInstance)
	...
	EEQSNormalizationType                              _NormalizationType;                                       // 0x00E4(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	class UNavMovementComponent*                       _MovementComp;                                            // 0x0130(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	class UCharacterMovementComponent*                 _CharacterMovement;                                       // 0x02A8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	class UBrainComponent*                             _BrainComp;                                               // 0x0048(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	class UAISystem*                                   _AISystem;                                                // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FAIDamageEvent                              _Event;                                                   // 0x0028(0x0030) (Edit, BlueprintVisible)
...
{
public:
	struct FAINoiseEvent                               _Event;                                                   // 0x0028(0x0030) (Edit, BlueprintVisible)
...
public:
	...
	class UBehaviorTreeManager*                        _BehaviorTreeManager;                                     // 0x00A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UEnvQueryManager*                            EnvironmentQueryManager;                                  // 0x00A8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UAIPerceptionSystem*                         _PerceptionSystem;                                        // 0x00B0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UAIAsyncTaskBlueprintProxy*>          AllProxyObjects;                                          // 0x00B8(0x0010) (ZeroConstructor, Transient)
	class UAIHotSpotManager*                           _HotSpotManager;                                          // 0x00C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	struct FAIMoveRequest                              _MoveRequest;                                             // 0x0090(0x0040)
...
public:
	...
	class UBlackboardComponent*                        _BlackboardComp;                                          // 0x0100(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
{
public:
	class UBrainComponent*                             _BrainComp;                                               // 0x00F8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
{
public:
	TEnumAsByte<EBTNodeResult>                         _Result;                                                  // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EEnvQueryRunMode>                      _RunMode;                                                 // 0x00C0(0x0001) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
...
{
public:
	struct FBlackboardKeySelector                      _BlackboardKey;                                           // 0x0078(0x0028) (Edit)
...
public:
	...
	TArray<struct FCrowdAvoidanceConfig>               _AvoidanceConfig;                                         // 0x0030(0x0010) (Edit, ZeroConstructor, Config)
...
public:
	...
	EPointOnCircleSpacingMethod                        _PointOnCircleSpacingMethod;                              // 0x0110(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FEnvTraceData                               _TraceData;                                               // 0x01B0(0x0030) (Edit)
...
public:
	...
	TArray<struct FEnvQueryInstanceCache>              _InstanceCache;                                           // 0x00A8(0x0010) (ZeroConstructor, Transient)
...
{
public:
	class UEnvQueryGenerator*                          _Generator;                                               // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FEnvOverlapData                             _OverlapData;                                             // 0x01C0(0x0020) (Edit, DisableEditOnInstance)
...
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x05B0(0x0040) MISSED OFFSET
...
public:
	...
	struct FNavAgentProperties                         _NavAgentProperties;                                      // 0x0790(0x0030) (Edit)
...
{
public:
	class UNavLocalGridManager*                        _GridManager;                                             // 0x02A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
