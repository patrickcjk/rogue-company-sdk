...
{
public:
	struct FMovieSceneTransformMask                    _TransformMask;                                           // 0x00E0(0x0004)
...
{
public:
	struct FMovieSceneActorReferenceData               _ActorReferenceData;                                      // 0x00E0(0x00A0)
...
{
public:
	class USoundBase*                                  _Sound;                                                   // 0x00E0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UEnum*                                       _Enum;                                                    // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UCameraAnim*                                 _CameraAnim;                                              // 0x0100(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	TEnumAsByte<ECameraAnimPlaySpace>                  _PlaySpace;                                               // 0x010C(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FMovieSceneEvent                            _Event;                                                   // 0x00E0(0x0008) (Edit)
...
{
public:
	struct FMovieSceneEventChannel                     _EventChannel;                                            // 0x00E0(0x0088)
...
{
public:
	ELevelVisibility                                   _Visibility;                                              // 0x00E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00E1(0x0007) MISSED OFFSET
...
{
public:
	struct FMovieSceneSkeletalAnimationParams          _Params;                                                  // 0x00E0(0x00D0) (Edit, BlueprintVisible)
	class UAnimSequence*                               _AnimSequence;                                            // 0x01B0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
