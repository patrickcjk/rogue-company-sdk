...
public:
	...
	EMovieSceneCaptureProtocolState                    _State;                                                   // 0x0050(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EHDRCaptureGamut>                      _CaptureGamut;                                            // 0x0070(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EHDRCaptureGamut>                      _CaptureGamut;                                            // 0x00D9(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	class UMovieSceneImageCaptureProtocolBase*         _ImageCaptureProtocol;                                    // 0x0068(0x0008) (Edit, ExportObject, ZeroConstructor, Transient, EditConst, InstancedReference, IsPlainOldData)
	class UMovieSceneAudioCaptureProtocolBase*         _AudioCaptureProtocol;                                    // 0x0070(0x0008) (Edit, ExportObject, ZeroConstructor, Transient, EditConst, InstancedReference, IsPlainOldData)
	struct FMovieSceneCaptureSettings                  _Settings;                                                // 0x0078(0x0060) (Edit, BlueprintVisible, Config)
	...
	struct FString                                     AdditionalCommandLineArguments;                           // 0x00E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, Config)
	struct FString                                     InheritedCommandLineArguments;                            // 0x00F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, Transient)
...
{
public:
	class UWorld*                                      _World;                                                   // 0x0058(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	EDesiredImageFormat                                _Format;                                                  // 0x00D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
