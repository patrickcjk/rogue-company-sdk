...
public:
	...
	struct FLinearColor                                _Color;                                                   // 0x0344(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FLinearColor                                _Color;                                                   // 0x003C(0x0010) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FDatasmithCameraLookatTrackingSettingsTemplate _LookatTrackingSettings;                                  // 0x0030(0x0030)
...
{
public:
	struct FDatasmithCameraFilmbackSettingsTemplate    _FilmbackSettings;                                        // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FDatasmithCameraLensSettingsTemplate        _LensSettings;                                            // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDatasmithCameraFocusSettingsTemplate       _FocusSettings;                                           // 0x003C(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	struct FDatasmithPostProcessSettingsTemplate       _PostProcessSettings;                                     // 0x0050(0x0040)
...
{
public:
	EDatasmithImportSearchPackagePolicy                _SearchPackagePolicy;                                     // 0x0028(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	...
	EDatasmithImportMaterialQuality                    _MaterialQuality;                                         // 0x002F(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0030(0x0004) MISSED OFFSET
	struct FDatasmithImportBaseOptions                 _BaseOptions;                                             // 0x0034(0x0014) (Edit, BlueprintVisible, Config)
	struct FDatasmithTessellationOptions               _TessellationOptions;                                     // 0x0048(0x0010) (Edit, BlueprintVisible, Config)
	struct FDatasmithReimportOptions                   _ReimportOptions;                                         // 0x0058(0x0002) (Edit, BlueprintVisible, Config)
	unsigned char                                      UnknownData01[0x6];                                       // 0x005A(0x0006) MISSED OFFSET
	struct FString                                     Filename;                                                 // 0x0060(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FString                                     FilePath;                                                 // 0x0070(0x0010) (BlueprintVisible, ZeroConstructor)
...
{
public:
	struct FDatasmithPostProcessSettingsTemplate       _Settings;                                                // 0x0030(0x0040)
...
{
public:
	class UDatasmithScene*                             _Scene;                                                   // 0x0330(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0338(0x0050) UNKNOWN PROPERTY: MapProperty DatasmithContent.DatasmithSceneActor.RelatedActors
...
public:
	...
	TEnumAsByte<EComponentMobility>                    _Mobility;                                                // 0x0060(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TEnumAsByte<ESkyLightSourceType>                   _SourceType;                                              // 0x0030(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0031(0x0003) MISSED OFFSET
...
{
public:
	class UStaticMesh*                                 _StaticMesh;                                              // 0x00E0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FDatasmithMeshSectionInfoMapTemplate        _SectionInfoMap;                                          // 0x0030(0x0050) (Edit, EditConst)
	...
	TArray<struct FDatasmithMeshBuildSettingsTemplate> _BuildSettings;                                           // 0x0088(0x0010) (Edit, ZeroConstructor, EditConst)
