...
struct FTouchRegion
{
	float                                              NormalizedX;                                              // 0x0000(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              NormalizedY;                                              // 0x0004(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              NormalizedWidth;                                          // 0x0008(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              NormalizedHeight;                                         // 0x000C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxFullAxisLengthOverride;                                // 0x0010(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxFullAxisDeadZoneLengthOverride;                        // 0x0014(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
{
	unsigned char                                      Default : 1;                                              // 0x0000(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      Friendly : 1;                                             // 0x0000(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      Enemy : 1;                                                // 0x0000(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      TaskForce1 : 1;                                           // 0x0000(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      TaskForce2 : 1;                                           // 0x0000(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00 : 3;                                        // 0x0000(0x0001)
	unsigned char                                      VerticalTargeter : 1;                                     // 0x0001(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      LocalOwner : 1;                                           // 0x0001(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      NotLocalOwner : 1;                                        // 0x0001(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01 : 5;                                        // 0x0001(0x0001)
	unsigned char                                      CustomFilter1 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      CustomFilter2 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      CustomFilter3 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      CustomFilter4 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      CustomFilter5 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible)
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	unsigned char                                      bOverride_MaterialSSR : 1;                                // 0x0000(0x0001) (Edit)
	unsigned char                                      MaterialSSR : 1;                                          // 0x0000(0x0001) (Edit)
	unsigned char                                      bOverride_HQForwardReflections : 1;                       // 0x0001(0x0001) (Edit)
	unsigned char                                      HQForwardReflections : 1;                                 // 0x0001(0x0001) (Edit)
	unsigned char                                      TwoSided : 1;                                             // 0x0001(0x0001) (Edit)
...
struct FLightmassLightSettings
{
	...
	bool                                               bExcludeFromVolumetricLightmap;                           // 0x0009(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x000A(0x0002) MISSED OFFSET
};
...
struct FSoundClassProperties
{
	...
	unsigned char                                      bApplyInsulationVolumes : 1;                              // 0x0024(0x0001) (Edit)
...
struct FMeshMergingSettings
{
	...
	bool                                               bPivotPointAtRoot;                                        // 0x0086(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAverageRootLocationsForFinalPivot;                       // 0x0087(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSplitForComplexity;                                      // 0x0088(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bUseTextureBinning : 1;                                   // 0x0089(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReuseMeshLightmapUVs : 1;                                // 0x0089(0x0001) (Edit)
	unsigned char                                      bMergeEquivalentMaterials : 1;                            // 0x0089(0x0001) (Edit)
	unsigned char                                      bUseLandscapeCulling : 1;                                 // 0x0089(0x0001) (Edit, BlueprintVisible)
...
struct FHierarchicalSimplification
{
	...
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x009C(0x008C) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x0128(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x012C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x0130(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FParticleCollisionPackedParams
{
	...
	float                                              EmitterTime;                                              // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ParticleTime;                                             // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Location;                                                 // 0x0010(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Velocity;                                                 // 0x001C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Direction;                                                // 0x0028(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Normal;                                                   // 0x0034(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       BoneName;                                                 // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPhysicalMaterial*                           PhysMat;                                                  // 0x0048(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    Source;                                                   // 0x0050(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
};
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	int8_t                                             UseCount;                                                 // 0x002C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8B];                                      // 0x002D(0x008B) MISSED OFFSET
};
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      bSmoothNormalsInVertexColor : 1;                          // 0x0000(0x0001) (Edit)
...
struct FLightmassWorldInfoSettings
{
	...
	bool                                               bEnableGpuLightmass;                                      // 0x004C(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x004D(0x0003) MISSED OFFSET
	int                                                NumPrimaryGISamples;                                      // 0x0050(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                NumSecondaryGISamples;                                    // 0x0054(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              FireflyClampingThreshold;                                 // 0x0058(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
};
