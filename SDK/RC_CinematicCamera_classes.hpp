...
{
public:
	struct FCameraLookatTrackingSettings               _LookatTrackingSettings;                                  // 0x0890(0x0050) (Edit, BlueprintVisible)
...
{
public:
	struct FCameraFilmbackSettings                     _FilmbackSettings;                                        // 0x0820(0x000C) (Edit, BlueprintVisible)
	struct FCameraLensSettings                         _LensSettings;                                            // 0x082C(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0844(0x0004) MISSED OFFSET
	struct FCameraFocusSettings                        _FocusSettings;                                           // 0x0848(0x0058) (Edit, BlueprintVisible)
	float                                              CurrentFocalLength;                                       // 0x08A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CurrentAperture;                                          // 0x08A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CurrentFocusDistance;                                     // 0x08A8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x08AC(0x000C) MISSED OFFSET
	TArray<struct FNamedFilmbackPreset>                FilmbackPresets;                                          // 0x08B8(0x0010) (ZeroConstructor, Config)
	TArray<struct FNamedLensPreset>                    LensPresets;                                              // 0x08C8(0x0010) (ZeroConstructor, Config)
	struct FString                                     DefaultFilmbackPresetName;                                // 0x08D8(0x0010) (ZeroConstructor, Config)
	struct FString                                     DefaultLensPresetName;                                    // 0x08E8(0x0010) (ZeroConstructor, Config)
