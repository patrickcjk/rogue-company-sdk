...
public:
	...
	struct FMovieSceneSequencePlaybackSettings         _PlaybackSettings;                                        // 0x0340(0x0014) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0354(0x0004) MISSED OFFSET
	class ULevelSequencePlayer*                        _SequencePlayer;                                          // 0x0358(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	...
	class ULevelSequenceBurnInOptions*                 _BurnInOptions;                                           // 0x0388(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMovieSceneBindingOverrides*                 _BindingOverrides;                                        // 0x0390(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FLevelSequenceBindingReferences             _BindingReferences;                                       // 0x03A0(0x00A0)
...
public:
	...
	class ULevelSequenceBurnInInitSettings*            _Settings;                                                // 0x0048(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	class ALevelSequenceActor*                         _LevelSequenceActor;                                      // 0x02C8(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class ULevelSequencePlayer*                        _Player;                                                  // 0x0028(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
