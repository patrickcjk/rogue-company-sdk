...
class UARCandidateImage* UARBlueprintLibrary::STATIC_AddRuntimeCandidateImage(class UARSessionConfig** SessionConfig, class UTexture2D** CandidateTexture, struct FString* FriendlyName, float* PhysicalWidth)
{
