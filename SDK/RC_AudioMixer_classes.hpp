...
{
public:
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0270(0x0001)
	unsigned char                                      bStopWhenOwnerDestroyed : 1;                              // 0x0270(0x0001)
	unsigned char                                      bAllowSpatialization : 1;                                 // 0x0270(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverrideAttenuation : 1;                                 // 0x0270(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0271(0x0003) MISSED OFFSET
	unsigned char                                      bOutputToBusOnly : 1;                                     // 0x0274(0x0001) (Edit, BlueprintVisible)
	...
	struct FSoundAttenuationSettings                   AttenuationOverrides;                                     // 0x0280(0x02E8) (Edit, BlueprintVisible)
	class USoundConcurrency*                           ConcurrencySettings;                                      // 0x0568(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0570(0x0050) UNKNOWN PROPERTY: SetProperty AudioMixer.SynthComponent.ConcurrencySet
	class USoundClass*                                 _SoundClass;                                              // 0x05C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USoundEffectSourcePresetChain*               SourceEffectChain;                                        // 0x05C8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USoundSubmix*                                _SoundSubmix;                                             // 0x05D0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FSoundSubmixSendInfo>                SoundSubmixSends;                                         // 0x05D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FSoundSourceBusSendInfo>             BusSends;                                                 // 0x05E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FSoundSourceBusSendInfo>             PreEffectBusSends;                                        // 0x05F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      bIsUISound : 1;                                           // 0x0608(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bIsPreviewSound : 1;                                      // 0x0608(0x0001)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0609(0x0003) MISSED OFFSET
	int                                                EnvelopeFollowerAttackTime;                               // 0x060C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                EnvelopeFollowerReleaseTime;                              // 0x0610(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0614(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnAudioEnvelopeValue;                                     // 0x0618(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0x20];                                      // 0x0628(0x0020) MISSED OFFSET
	class USynthSound*                                 _Synth;                                                   // 0x0648(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UAudioComponent*                             _AudioComponent;                                          // 0x0650(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData06[0x28];                                      // 0x0658(0x0028) MISSED OFFSET
...
public:
	...
	struct FSubmixEffectDynamicsProcessorSettings      _Settings;                                                // 0x0090(0x0028) (Edit, BlueprintVisible)
...
public:
	...
	struct FSubmixEffectSubmixEQSettings               _Settings;                                                // 0x0078(0x0010) (Edit, BlueprintVisible)
...
public:
	...
	struct FSubmixEffectReverbSettings                 _Settings;                                                // 0x009C(0x0034) (Edit, BlueprintVisible)
