...
{
	unsigned char                                      UnknownData00[0x28];                                      // 0x0000(0x0028) UNKNOWN PROPERTY: SoftObjectProperty AnimationSharing.AnimationSetup.AnimSequence
...
struct FPerSkeletonAnimationSharingSetup
{
	...
	unsigned char                                      UnknownData01[0x28];                                      // 0x0028(0x0028) UNKNOWN PROPERTY: SoftObjectProperty AnimationSharing.PerSkeletonAnimationSharingSetup.SkeletalMesh
