...
public:
	...
	class UNetDriver*                                  _NetDriver;                                               // 0x0340(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	EBeaconConnectionState                             _ConnectionState;                                         // 0x0370(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	EClientRequestType                                 _RequestType;                                             // 0x0430(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UPartyBeaconState*                           _State;                                                   // 0x0358(0x0008) (ZeroConstructor, IsPlainOldData)
