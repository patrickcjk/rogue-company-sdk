...
{
public:
	class UGeometryCollection*                         _GeometryCollection;                                      // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UStaticMesh*                                 _StaticMesh;                                              // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
