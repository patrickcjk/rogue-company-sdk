...
{
public:
	class UNiagaraComponent*                           _NiagaraComponent;                                        // 0x0330(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	class UNiagaraSystem*                              Asset;                                                    // 0x05B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FNiagaraUserRedirectionParameterStore       OverrideParameters;                                       // 0x05B8(0x0138) (Edit)
	unsigned char                                      bForceSolo : 1;                                           // 0x06F0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x27];                                      // 0x06F1(0x0027) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0718(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x0718(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x0718(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0719(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemFinished;                                         // 0x0720(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x0730(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	struct FName                                       AutoAttachSocketName;                                     // 0x0738(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachLocationRule;                                   // 0x0740(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachRotationRule;                                   // 0x0741(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachScaleRule;                                      // 0x0742(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3D];                                      // 0x0743(0x003D) MISSED OFFSET
...
{
public:
	struct FRichCurve                                  _Curve;                                                   // 0x0068(0x0080) (Edit)
...
public:
	...
	ENDISkeletalMesh_SkinningMode                      _SkinningMode;                                            // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class AActor*                                      Source;                                                   // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FNDIStaticMeshSectionFilter                 _SectionFilter;                                           // 0x0038(0x0010) (Edit)
...
public:
	...
	class UTexture*                                    _Texture;                                                 // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UVectorField*                                _Field;                                                   // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	ENiagaraSimTarget                                  _SimTarget;                                               // 0x00D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TArray<class UNiagaraRendererProperties*>          _RendererProperties;                                      // 0x0118(0x0010) (ZeroConstructor)
...
public:
	...
	ENiagaraSortMode                                   _SortMode;                                                // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	ENiagaraMeshFacingMode                             _FacingMode;                                              // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UNiagaraParameterCollection*                 _Collection;                                              // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UMaterialInterface*                          _Material;                                                // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraRibbonFacingMode                           _FacingMode;                                              // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0039(0x0003) MISSED OFFSET
	...
	ENiagaraRibbonDrawDirection                        _DrawDirection;                                           // 0x0069(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	ENiagaraScriptUsage                                _Usage;                                                   // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	ENiagaraNumericOutputTypeSelectionMode             _NumericOutputTypeSelectionMode;                          // 0x0130(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	class UMaterialInterface*                          _Material;                                                // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraSpriteAlignment                            _Alignment;                                               // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraSpriteFacingMode                           _FacingMode;                                              // 0x0039(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	ENiagaraSortMode                                   _SortMode;                                                // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0051(0x0003) MISSED OFFSET
...
public:
	...
	TArray<struct FNiagaraEmitterSpawnAttributes>      _EmitterSpawnAttributes;                                  // 0x0070(0x0010) (ZeroConstructor)
