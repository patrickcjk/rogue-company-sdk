...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool*                          bInAllowInterpolation          (Parm, ZeroConstructor, IsPlainOldData)

void UWidget::SetAllowRenderInterpolation(bool* bInAllowInterpolation)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.Widget.SetAllowRenderInterpolation");
...
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction UMG.ComboBoxString.OnClosingEvent__DelegateSignature");
