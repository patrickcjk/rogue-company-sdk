...
{
public:
	class UARTrackedGeometry*                          _TrackedGeometry;                                         // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	EARTrackingState                                   _TrackingState;                                           // 0x00A0(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	EARWorldAlignment                                  _WorldAlignment;                                          // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EARSessionType                                     _SessionType;                                             // 0x0031(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EARPlaneDetectionMode                              _PlaneDetectionMode;                                      // 0x0032(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	EARLightEstimationMode                             _LightEstimationMode;                                     // 0x0036(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EARFrameSyncMode                                   _FrameSyncMode;                                           // 0x0037(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	EAREnvironmentCaptureProbeType                     _EnvironmentCaptureProbeType;                             // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	EARFaceTrackingDirection                           _FaceTrackingDirection;                                   // 0x0084(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EARFaceTrackingUpdate                              _FaceTrackingUpdate;                                      // 0x0085(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UAREnvironmentCaptureProbe*                  _CaptureProbe;                                            // 0x0340(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	EARTextureType                                     _TextureType;                                             // 0x00B8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	EARDepthQuality                                    _DepthQuality;                                            // 0x00D8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EARDepthAccuracy                                   _DepthAccuracy;                                           // 0x00D9(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	EARTextureType                                     _TextureType;                                             // 0x0110(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	EARTrackingState                                   _TrackingState;                                           // 0x0090(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	EARCandidateImageOrientation                       _Orientation;                                             // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
