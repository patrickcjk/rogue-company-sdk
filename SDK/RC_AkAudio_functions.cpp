...
void UAkGameplayStatics::STATIC_UseEarlyReflections(class AActor** Actor, class UAkAuxBus** AuxBus, int* Order, float* BusSendGain, float* MaxPathLength, bool* SpotReflectors, struct FString* AuxBusName)
{
...
void UAkGameplayStatics::STATIC_UnloadBank(class UAkAudioBank** Bank, struct FString* BankName, struct FLatentActionInfo* LatentInfo, class UObject** WorldContextObject)
{
...
// struct FRotator*               Orientation                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
...
class UAkComponent* UAkGameplayStatics::STATIC_SpawnAkComponentAtLocation(class UObject** WorldContextObject, class UAkAudioEvent** AkEvent, class UAkAuxBus** EarlyReflectionsBus, struct FVector* Location, struct FRotator* Orientation, bool* AutoPost, struct FString* EventName, struct FString* EarlyReflectionsBusName, bool* AutoDestroy)
{
...
// struct FName*                  SwitchState                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// class AActor**                 Actor                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Final, BlueprintCosmetic, Native, Static, Public, HasOutParms, BlueprintCallable)
// Parameters:
// struct FName*                  StateGroup                     (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// struct FName*                  State                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
...
void UAkGameplayStatics::STATIC_SetSpeakerAngles(TArray<float>* SpeakerAngles, float* HeightAngle, struct FString* DeviceShareset)
{
...
// TArray<struct FTransform>*     Positions                      (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// Parameters:
// class UAkComponent**           GameObjectAkComponent          (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
// TArray<EAkChannelConfiguration>* ChannelMasks                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// TArray<struct FTransform>*     Positions                      (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// EAkMultiPositionType*          MultiPositionType              (Parm, ZeroConstructor, IsPlainOldData)
...
void UAkGameplayStatics::STATIC_SetBusConfig(struct FString* BusName, EAkChannelConfiguration* ChannelConfiguration)
{
...
// (Final, BlueprintCosmetic, Native, Static, Public, HasOutParms, BlueprintCallable)
// Parameters:
// struct FName*                  Trigger                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// class AActor**                 Actor                          (Parm, ZeroConstructor, IsPlainOldData)
...
void UAkGameplayStatics::STATIC_PostEventAtLocationByName(struct FString* EventName, struct FVector* Location, struct FRotator* Orientation, class UObject** WorldContextObject)
{
...
int UAkGameplayStatics::STATIC_PostEventAtLocation(class UAkAudioEvent** AkEvent, struct FVector* Location, struct FRotator* Orientation, struct FString* EventName, class UObject** WorldContextObject)
{
...
int UAkGameplayStatics::STATIC_PostEvent(class UAkAudioEvent** AkEvent, class AActor** Actor, int* CallbackMask, struct FScriptDelegate* PostEventCallback, bool* bStopWhenAttachedToDestroyed, struct FString* EventName)
{
...
int UAkGameplayStatics::STATIC_PostAndWaitForEndOfEvent(class UAkAudioEvent** AkEvent, class AActor** Actor, bool* bStopWhenAttachedToDestroyed, struct FString* EventName, struct FLatentActionInfo* LatentInfo)
{
...
void UAkGameplayStatics::STATIC_LoadBank(class UAkAudioBank** Bank, struct FString* BankName, struct FLatentActionInfo* LatentInfo, class UObject** WorldContextObject)
{
...
void UAkGameplayStatics::STATIC_GetSpeakerAngles(struct FString* DeviceShareset, TArray<float>* SpeakerAngles, float* HeightAngle)
{
...
void UAkGameplayStatics::STATIC_CancelEventCallback(struct FScriptDelegate* PostEventCallback)
{
...
struct FString UAkItemBoolPropertiesConv::STATIC_Conv_FAkBoolPropertyToControlToString(struct FAkBoolPropertyToControl* INAkBoolPropertyToControl)
{
...
struct FString UAkItemPropertiesConv::STATIC_Conv_FAkPropertyToControlToString(struct FAkPropertyToControl* INAkPropertyToControl)
{
...
struct FString UAkWaapiCalls::STATIC_Conv_FAkWaapiSubscriptionIdToString(struct FAkWaapiSubscriptionId* INAkWaapiSubscriptionId)
{
...
struct FString USAkWaapiFieldNamesConv::STATIC_Conv_FAkWaapiFieldNamesToString(struct FAkWaapiFieldNames* INAkWaapiFieldNames)
{
...
struct FAKWaapiJsonObject UAkWaapiJsonManager::STATIC_SetStringField(struct FAkWaapiFieldNames* FieldName, struct FString* FieldValue, struct FAKWaapiJsonObject* Target)
{
...
struct FAKWaapiJsonObject UAkWaapiJsonManager::STATIC_SetArrayStringFields(struct FAkWaapiFieldNames* FieldName, TArray<struct FString>* FieldStringValues, struct FAKWaapiJsonObject* Target)
{
...
struct FString UAkWaapiJsonManager::STATIC_GetStringField(struct FAkWaapiFieldNames* FieldName, struct FAKWaapiJsonObject* Target)
{
...
struct FString UAkWaapiJsonManager::STATIC_Conv_FAKWaapiJsonObjectToString(struct FAKWaapiJsonObject* INAKWaapiJsonObject)
{
...
struct FString UAkWaapiUriConv::STATIC_Conv_FAkWaapiUriToString(struct FAkWaapiUri* INAkWaapiUri)
{
