...
public:
	...
	struct FNavDataConfig                              _NavDataConfig;                                           // 0x0340(0x0068)
	...
	ERuntimeGenerationType                             _RuntimeGeneration;                                       // 0x03AC(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	struct FNavGraphNode                               _Node;                                                    // 0x0270(0x0018)
	class UNavigationGraphNodeComponent*               NextNodeComponent;                                        // 0x0288(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UNavigationGraphNodeComponent*               PrevNodeComponent;                                        // 0x0290(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	ENavDataGatheringModeConfig                        _DataGatheringMode;                                       // 0x0064(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      UnknownData07[0xCC];                                      // 0x0128(0x00CC) MISSED OFFSET
	EFNavigationSystemRunMode                          OperationMode;                                            // 0x01F4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x23B];                                     // 0x01F5(0x023B) MISSED OFFSET
...
public:
	...
	class UNavigationInvokerComponent*                 _InvokerComponent;                                        // 0x0348(0x0008) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	TArray<struct FNavigationLink>                     Links;                                                    // 0x05B8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	TEnumAsByte<ENavLinkDirection>                     _LinkDirection;                                           // 0x0160(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UNavigationSystemConfig*                     _NavigationSystemConfig;                                  // 0x0330(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
