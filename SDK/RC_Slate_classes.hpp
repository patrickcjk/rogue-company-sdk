...
{
public:
	struct FButtonStyle                                _ButtonStyle;                                             // 0x0030(0x0278) (Edit, BlueprintVisible)
...
{
public:
	struct FCheckBoxStyle                              _CheckBoxStyle;                                           // 0x0030(0x0580) (Edit)
...
{
public:
	struct FComboBoxStyle                              _ComboBoxStyle;                                           // 0x0030(0x03D8) (Edit)
...
{
public:
	struct FComboButtonStyle                           _ComboButtonStyle;                                        // 0x0030(0x03A0) (Edit)
...
{
public:
	struct FEditableTextBoxStyle                       _EditableTextBoxStyle;                                    // 0x0030(0x07F0) (Edit)
...
{
public:
	struct FEditableTextStyle                          _EditableTextStyle;                                       // 0x0030(0x0218) (Edit)
...
{
public:
	struct FProgressBarStyle                           _ProgressBarStyle;                                        // 0x0030(0x01A0) (Edit, BlueprintVisible)
...
{
public:
	struct FScrollBarStyle                             _ScrollBarStyle;                                          // 0x0030(0x04D0) (Edit)
...
{
public:
	struct FScrollBoxStyle                             _ScrollBoxStyle;                                          // 0x0030(0x0228) (Edit)
...
{
public:
	struct FSpinBoxStyle                               _SpinBoxStyle;                                            // 0x0030(0x02E8) (Edit)
...
{
public:
	struct FTextBlockStyle                             _TextBlockStyle;                                          // 0x0030(0x0268) (Edit)
