...
{
public:
	struct FMovieSceneSectionEvalOptions               _EvalOptions;                                             // 0x0050(0x0002) (Edit)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0052(0x0006) MISSED OFFSET
	struct FMovieSceneEasingSettings                   _Easing;                                                  // 0x0058(0x0038) (Edit)
	...
	struct FOptionalMovieSceneBlendType                _BlendType;                                               // 0x00C9(0x0002)
...
{
public:
	struct FMovieSceneTrackEvalOptions                 _EvalOptions;                                             // 0x0050(0x0004) (Edit)
...
public:
	...
	TEnumAsByte<EMovieScenePlayerStatus>               _Status;                                                  // 0x03C0(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	class UMovieSceneSequence*                         _Sequence;                                                // 0x03C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	...
	struct FMovieSceneSequencePlaybackSettings         _PlaybackSettings;                                        // 0x03F0(0x0014) (Net)
	...
	TScriptInterface<class UMovieScenePlaybackClient>  _PlaybackClient;                                          // 0x0780(0x0010) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	EMovieSceneEvaluationType                          _EvaluationType;                                          // 0x00C8(0x0001) (ZeroConstructor, IsPlainOldData)
	EUpdateClockSource                                 _ClockSource;                                             // 0x00C9(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	class UCurveFloat*                                 _Curve;                                                   // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FMovieSceneSectionParameters                _Parameters;                                              // 0x00E0(0x0018) (Edit, BlueprintVisible)
