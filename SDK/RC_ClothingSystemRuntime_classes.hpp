...
{
public:
	class UPhysicsAsset*                               _PhysicsAsset;                                            // 0x0048(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FClothConfig                                _ClothConfig;                                             // 0x0050(0x00D4) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0124(0x0004) MISSED OFFSET
	TArray<struct FClothLODData>                       _LODData;                                                 // 0x0128(0x0010) (ZeroConstructor)
	...
	class UClothingAssetCustomData*                    _CustomData;                                              // 0x0170(0x0008) (ZeroConstructor, IsPlainOldData)
